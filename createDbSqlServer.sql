...
('Repsol Honda', 'Japón', 120000000.0, 300, '1982-01-01', 1, NULL, NULL),
('Ducati Lenovo', 'Italia', 95000000.0, 180, '2003-01-01', 1, NULL, NULL),
('Monster Yamaha', 'Japón', 85000000.0, 210, '1999-01-01', 1, NULL, NULL);
...
('Honda', 'RC213V', 1000, 260.50, 157.0, 2024, 'Rojo y Blanco', NULL, NULL),
('Ducati', 'Desmosedici GP24', 1000, 270.80, 157.0, 2024, 'Rojo', NULL, NULL),
('Yamaha', 'YZR-M1', 1000, 255.30, 157.0, 2024, 'Azul y Negro', NULL, NULL);
...
('Circuit de Barcelona-Catalunya', 'España', 'Montmeló', 4.655, 16, 1, '1991-09-10', NULL, NULL),
('Autodromo del Mugello', 'Italia', 'Scarperia', 5.245, 15, 1, '1974-03-01', NULL, NULL),
('Circuito de Jerez', 'España', 'Jerez de la Frontera', 4.423, 13, 1, '1986-10-04', NULL, NULL);
...
('Marc Márquez', 'Española', 93, 8, '1993-02-17', 1, NULL, NULL, 1, 1, 1, 1),
('Francesco Bagnaia', 'Italiana', 1, 2, '1997-01-14', 1, NULL, NULL, 1, 2, 2, 2),
('Fabio Quartararo', 'Francesa', 20, 1, '1999-04-20', 1, NULL, NULL, 2, 3, 3, 3);
